...
<div style="z-index:3;" class="" ng-show="toggle.isShowWxShareMsg">
        <div class="weui_mask_transparent" style="background-color: rgba(0,0,0,0.6);z-index:0;"></div>
        <div class="" style="position: fixed;top: 0;left: 0;" ng-click="toggle.isShowWxShareMsg=!toggle.isShowWxShareMsg">
            <img src="../sp/img/casio/蒙版.png" style="width: 100%;">
        </div>
</div>
