...
<!-- confirm Page -->
 <div ng-class="{true: 'weui_dialog class_show', false : 'weui_dialog class_hide'}[isConfirmDialogShow]" style="border:3px solid #0f0f0f; z-index:2;">
        <div class="weui_dialog_hd"><strong class="weui_dialog_title">提示</strong></div>
        <div class="weui_dialog_bd"> {{confirmMessage}}
        <br/>
        </div>
        <div class="weui_dialog_ft">
           <a href="javascript:;" class="weui_btn_dialog primary" ng-click="toggleConfirmDialogOK()">确 认</a>
           <a href="javascript:;" class="weui_btn_dialog primary" style="color: rgba(0,0,0,0.5);" ng-click="toggleConfirmDialogCancel()">取 消</a>
        </div>
    </div> 
