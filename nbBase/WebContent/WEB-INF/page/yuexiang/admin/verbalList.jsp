...
<body ng-app="zaApp">
    ...
    <div id="wrapper" >
        ...
        <div id="page-wrapper" 
        ng-controller="verbalListController"  ng-init="initial()">
        <!-- Page Content -->
        <!-- 这条线以上不要加页面代码 -->
        <!-- --------------------------------------------------------------- -->
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        ng-click="gotoVerbalDetail(bookX.id)">
                                           ...
                                           <!--  <td ng-bind="userX.userInfoId" style="vertical-align: middle;"></td> -->
                                            ...
                                            <td ng-bind="bookX.bookWriter" style="vertical-align: middle;"></td>
  ...
  <script src="../sp/ajController/yuexiang/admin/verbalListController.js"></script>
