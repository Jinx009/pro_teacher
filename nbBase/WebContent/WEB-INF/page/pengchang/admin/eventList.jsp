...
<body ng-app="zaApp">
    ...
    <div id="wrapper" >
        ...
        <div id="page-wrapper" 
        ng-controller="eventListController"  ng-init="initial()">
        <!-- Page Content -->
        <!-- 这条线以上不要加页面代码 -->
        <!-- --------------------------------------------------------------- -->
        ...
        <div class="col-lg-4" ng-repeat="eventX in pageData.events"
        ng-click="gotoConfigEvent(eventX.id)">
                    <div class="panel panel-default">
                        <div class="panel-heading" ng-bind="eventX.eventTitle.length > 0 ? eventX.eventTitle : '&nbsp'">
                        ...
                        >
                        	...
                        	text-align:center;">
                            	<img 
                            	style="height:100%;"
                            	ng-src="{{eventX.eventHeadImgUrl}}" />
                            </div>
                        </div>
                        <div class="panel-footer" ng-bind="eventX.eventWxConfigName">
  ...
  <script src="../sp/ajController/pengchang/admin/eventListController.js"></script>
