...
<body ng-app="zaApp" ng-controller="myPengListController" ng-init="initial()" >
<br/>
<div class="weui_panel_bd">


<div ng-repeat="orderx in orders">
   <div class="weui_media_box weui_media_appmsg" style="border-bottom:1px solid #f0f0f0;" ng-click="goMyPeng(orderx.orderId)">
       ...
       <div class="weui_media_bd">
           <h4 class="weui_media_title">{{orderx.eventTitle}}</h4>
           <p class="weui_media_desc">{{orderx.eventDesc}}</p>
       </div>
   </div>
</div>
</div>
...
<br/>
	...
	<script type="text/javascript" src="./sp/ajController/pengchang/front/myPengListController.js" ></script>
</html>