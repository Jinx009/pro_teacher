...
<head>
  ...
  <title>活动列表</title>
	...
	<link rel="stylesheet" type="text/css" href="../sp/css/other/eventList.css" media="all">   
</head>
...
<script type="text/javascript" src="../sp/ajController/other/earnEventsController.js" ></script>
