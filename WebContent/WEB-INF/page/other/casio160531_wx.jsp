...
<tr>
	<td style="width: 50%;text-align: center;">
		...
		ng-show="pageData.picUrl[0].length==0"
		ng-click="chooseNewPic(0)">
		...
		ng-show="pageData.picUrl[0].length>0"
		ng-click="chooseNewPic(0)">
			<div style="position:absolute;top:0;left:0;width:100%;height:100%;background-image:url({{pageData.picUrl[0]}});background-size:cover;">
			<div style="font-size: 3vw;position: absolute;width: 100%;bottom: 10%;color: white;text-shadow: 0px 0px 10px #624242;">
		    		#30年，音为梦想#
		   	</div>
			</div>
		...
		<label style="text-decoration: underline;margin-top: 0.5em;"
		ng-click="chooseNewPic(0)">点击上传</label>
	</td>
	<td style="width: 50%;text-align: center;">
		<div style="width:100%;position:relative;display: inline-block;">
		<div style="margin-top:100%;"></div>
		<div style="position:absolute;top: 0;bottom: 0;left: 0;right: 0;border: 0.7em solid transparent;border-image: url(../sp/img/casio/相框底.png) 10 10 round;"
		ng-show="pageData.picUrl[1].length==0"
		ng-click="chooseNewPic(1)">
		<!-- <img src="../sp/img/casio/相框底.png" style="width:100%;"/> -->
			<div style="background: -webkit-linear-gradient(#B9A996,#F2EEE6,white);width:100%;height:100%;">
			</div>
			<div style="font-size: 4vw;position: absolute;width: 100%;top: 10%;color: white;">
		...
		ng-show="pageData.picUrl[1].length>0"
		ng-click="chooseNewPic(1)">
			<div style="position:absolute;top:0;left:0;width:100%;height:100%;background-image:url({{pageData.picUrl[1]}});background-size:cover;">
			<div style="font-size: 3vw;position: absolute;width: 100%;bottom: 10%;color: white;text-shadow: 0px 0px 10px #624242;">
		    		#30年，音为梦想#
		   	</div>
			</div>
		...
		<label style="text-decoration: underline;margin-top: 0.5em;"
		ng-click="chooseNewPic(1)">点击上传</label>
	</td>
</tr>
</tbody>
</table>
