...
<html ng-app="zaApp">
	<head>
		...
		<script type="text/javascript" src="./sp/ajController/teacherOnline/front/resetPasswordController.js"> </script>
	...
	<body class="login-bg">
		...
		<div class="login-content py4 login-bottom-pc" ng-controller="resetPasswordController">
			<div class="container">
				<div class="login-wrap">
					<div class="login-top">
						<h3 class="login-title">通过手机重置密码：</h3>
						...
						<!-- 密码 start -->
							<div ng-class="{'form-group':flagPasswordError==0,
									...
									<input type="password" class="form-control input-lg" placeholder="新的密码" ng-model="password" ng-change="checkInput(false,'password');checkInput(false,'confirmPassword')">
						...
						<!-- 再次密码 end -->
							...
							<button type="button" class="btn project-detail-btn" ng-click="resetPassword()">重置密码</button>
						</form>
					</div>
					<div class="login-bottom">
						取消重置<a href="login.html">重新登录</a>
					</div>
				</div>	
			</div>
		</div>
