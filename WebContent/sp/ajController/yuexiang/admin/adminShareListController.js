zaApp.controller('adminShareListController',function($scope, $rootScope, $attrs, $http, $location, sessionService, QueryParamService, modalInitialService){
	...
	$scope.initial = function(){
		...
		console.log($rootScope.selectedMenuCode);
	...
	$scope.gotoBookShareDetail = function(bookid){
		window.location.href = $rootScope.urlPath + "/adminShareDetail.html?bookId="+bookid+"&isWarehouse="+param.isWarehouse;
	}
