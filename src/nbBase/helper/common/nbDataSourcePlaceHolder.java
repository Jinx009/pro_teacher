		...
		if (this.locations != null) {
			for (int i = 0; i < this.locations.length; i++) {
				...
				try {
					...
					String subProjectPath = CommonHelper.loadAppSpecifiedConfig("subAppRootPath");
					if( subProjectPath == null  || subProjectPath.length() == 0){
						subProjectPath = "jdbc";
					}
					
					props.put("jdbc.url", props.get(subProjectPath+".url"));
					props.put("jdbc.username", props.get(subProjectPath+".username"));
					props.put("jdbc.password", props.get(subProjectPath+".password"));
