...
import nbBase.helper.common.ApplicationContextProvider;
import nbBase.helper.common.ReflectUtil;
import nbBase.helper.common.StringUtil;
import nbBase.helper.common.nbTransactionInterceptor;

@Transactional
public class BaseDaoImpl_backup<T> implements BaseDao<T> {

	private static final Logger logger = Logger.getLogger(BaseDaoImpl_backup.class);
